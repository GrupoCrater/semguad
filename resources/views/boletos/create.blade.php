                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('talla') is-invalid @enderror" name="talla"
                                        ...
                                        <option value="Niño: Chica"
                                            {{ old('talla') == 'Niño: Chica' ? 'selected' : '' }}>Niño: Chica</option>
                                        ...
                                        <option value="Adulto: Extra-chica"
                                            {{ old('talla') == 'Adulto: Extra-chica' ? 'selected' : '' }}>Adulto: Extra
                                            Chica</option>
                                        <option value="Adulto: Chica"
                                            {{ old('talla') == 'Adulto: Chica' ? 'selected' : '' }}>Adulto: Chica
                                        </option>
                                        <option value="Adulto: Mediana"
                                            {{ old('talla') == 'Adulto: Mediana' ? 'selected' : '' }}>Adulto: Mediana
                                        </option>
                                        ...
                                        <option value="Adulto: XXL"
                                            {{ old('talla') == 'Adulto: XXL' ? 'selected' : '' }}>Adulto: XXL</option>
                                    </select>
                                    @error('talla')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('prueba') is-invalid @enderror" name="prueba"
                                        ...
                                        <option value="Junior A: 600m"
                                            {{ old('prueba') == 'Junior A: 600m' ? 'selected' : '' }}>Junior A: 600 m
                                            (6-11 años)</option>
                                        ...
                                        <option value="Junior D: 2km"
                                            ...
                                            (16-17 años)</option>
                                        <option value="Especial" {{ old('prueba') == 'Especial' ? 'selected' : '' }}>
